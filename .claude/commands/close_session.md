...
## Шаг 4.5. Наследование хвостов предыдущего handoff (ОБЯЗАТЕЛЬНО, до перезаписи)

Прочитать «Следующий шаг» и «Хвосты» **предыдущего** handoff'а — **из файла**
(`git show HEAD:docs/SESSION_HANDOFF.md`), а не по памяти: сессия своих хвостов
не помнит, git их отдаёт. Для каждого пункта явно выбрать одно из трёх:
